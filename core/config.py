...
config.DATASET.num_pairs = 10
config.DATASET.num_clips = 256
# train
config.TRAIN = edict()
...
config.LOSS.contrast = 1.0
config.LOSS.cont = 1.0
config.LOSS.iou = 1.0
config.LOSS.saliency_margin = 0.2
config.LOSS.hy_sigma = 1.0
config.LOSS.contrast_weight = True
